        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingNumber = table.Column<int>(type: "int", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUser_CheckEmail", "Email LIKE '%_@__%.__%' ");
                    table.CheckConstraint("GymUser_CheckPhoneNumber", "PhoneNumber LIKE '01%' and PhoneNumber NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Plan_DurationDaysChick", "DurationDays between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUser_CheckEmail1", "Email LIKE '%_@__%.__%' ");
                    table.CheckConstraint("GymUser_CheckPhoneNumber1", "PhoneNumber LIKE '01%' and PhoneNumber NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Session_CapacityChick", "Capacity between 1 and 25");
